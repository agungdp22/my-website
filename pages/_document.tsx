...
class MyDocument extends Document {
  render() {
    const title = "Agung Dwi Prasetyo";
    const description = "Agung Dwi Prasetyo's portfolio website.";
    const url = "https://agungdwiprasetyo.com";
      ...
      <html lang="en" dir="ltr" prefix="og: http://ogp.me/ns# profile: http://ogp.me/ns/profile# fb: http://ogp.me/ns/fb#">
        <Head>
          ...
          <link
            ...
            sizes="256x256"
          /> */}
          <link rel="shortcut icon" href="https://storage.googleapis.com/agungdp/static/agungdwiprasetyo.com/pcb.png" />
          {/* DNS prefetch */}
          ...
          <meta property="profile:username" content="agungdwiprasetyo" />
          {/* Twitter Cards */}
          <meta name="twitter:card" content="summary" />
          <meta name="twitter:site" content="@agungdwprasetyo" />
